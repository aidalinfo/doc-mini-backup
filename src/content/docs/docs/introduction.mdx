...
<LinkCard
    ...
    description="Configuration détaillée du server"
/>


Pour commencer avec les meilleures conditions, vous devez choisir si vous voulez utilisez la version docker ou build le projet pour le deployer.

<CardGrid>
    <LinkCard
    title="Docker"
    href="/docs/installation/docker"
    description="Guide d'installation avec docker'"
    />
    <LinkCard
    title="Binaires"
    href="/docs/installation/binaries"
    description="Guide d'installation pour build le projet"
    />
</CardGrid>